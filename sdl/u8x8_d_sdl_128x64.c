...
static void u8g_sdl_init(int width, int height)
{
  ...
  u8g_sdl_color[1] = SDL_MapRGB( u8g_sdl_screen->format, W(255, 50), W(255,50), W(255,50) );
  u8g_sdl_color[2] = SDL_MapRGB( u8g_sdl_screen->format, W(255, 80), W(255,80), W(255,80) );
